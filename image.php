...
class image
{
    ...
    public function crop_image($original_file_name,$croped_file_name,$max_width,$max_height)
    {
       ...
       imagejpeg($new_cropped_image,$croped_file_name,90);
    ...
    public function get_thumb_wallpaper($filename)
    {
    ...
    public function get_thumb_profile_pic($filename)
    {
